              ...
              <div className="row mx-auto justify-content-center shadow-lg py-5 my-5 text-center rounded-3 bg-white" style={{maxWidth:"940px"}}>
                <div className="card border-0 bg-transparent">
                  ...
                  <div className="col-12 col-lg-auto mt-3 mt-lg-0">
										<Link><img src="/assets/img/googleplay.png" height="54" alt="" className="mt-3"/></Link>
										<Link><img src="/assets/img/appstore.png" className="ms-xl-3 ms-lg-1 mt-3 ms-0 " alt="" height="54"/></Link>
									</div>
								</div>
              </div>
            </div>
