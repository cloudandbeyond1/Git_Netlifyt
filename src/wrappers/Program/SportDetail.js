//  import * as animateScroll from 'react-scroll';
...
<div className="slider-btn  funfact-btn funfact-btn-violet btn-hover mt-4">
        ...
        <div className="blockquote-block bg-white" id="expert">
          ...
          <img src="https://lyma.life/assets/images/laser/expert-review-graeme_glass@2x.webp" className="img-fluid" alt="Rezingo"/>
          </div>
          <h4>Joshua Aaron</h4>
