                            ...
                            <form>
                              ...
                              <div className="button-box">
                               ...
                               <div className="social-media">
                                ...
                                <img src="/assets/img/icon-img/google.png" alt=""  style={{width:"27px",height:"27px"}}/>
                                </Link >
                                </div>
                                <div className="social-icon">
                                <Link  to={"https://facebook.com/"}>
                                <img src="/assets/img/icon-img/facebook.png" alt="" style={{width:"27px",height:"27px"}}/>
                                </Link >
                                </div>
                                <div className="social-icon">
                                  <Link  to={"https://twitter.com/"}>
                                <img src="/assets/img/icon-img/twitter.png" alt="" style={{width:"37px",height:"37px"}}/>
                                </Link >
                               </div>
