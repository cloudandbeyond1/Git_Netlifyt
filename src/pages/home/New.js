        ...
        <div className="row align-items-center">
          ...
          <div className="col-md-6 col-xs-6 col-lg-6 order-1 order-lg-1">
            ...
            <h3 className="f-60">Embrace Comprehensive Wellness</h3>
              <p className="pt-4 home">The Rezingo encompasses all the dimensions of wellness, guiding your journey towards a healthier, more balanced life.</p>
              {/* ll<div id="cta-waitlist-input" class="mb-12" style={{position:" relative"}}>
