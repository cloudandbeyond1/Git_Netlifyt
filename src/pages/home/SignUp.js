...
import { auth, createUserWithEmailAndPassword,database,sendEmailVerification, ref,set   } from "../../firebase";
  ...
  const validationSchema = Yup.object().shape({
    ...
    const handleRegistration = async (e) => {
      ...
      try {
        ...
        console.log(authResult,"authResult12");
         await sendEmailVerification(authResult.user);
        // console.log(authResult,"authResult1");
        ...
        //  console.log(auth,"auth");
         if (auth.currentUser.emailVerified) {
          console.log(auth.currentUser.emailVerified,"verification");
         }
         else{
          console.log(auth.currentUser.emailVerified,"not verify");
         }
 ...
 */}
      ...
      {/* <Link to={process.env.PUBLIC_URL + "/"} className="btn btn-primary" style={{fontSize: "10px",borderRadius:"0px"}} role="button">Send Verification Code</Link> */}
    ...
    <div class="custom-check">
		<input type="checkbox" checked {...register('termsOfService')}
            ...
            <label for="remember">By signing up, you agree to 
            <Link to={process.env.PUBLIC_URL + "/"}  className="link create-account">Terms of Service</Link>
            {/* <a href="#">Terms of Service</a>  */}
            and
            <Link to={process.env.PUBLIC_URL + "/"}  className="link create-account">Privacy Policy.</Link>
             {/* <a href="#" class="link create-account">Privacy Policy.</a> */}
             </label>     
        </div>
    ...
    <div class="register-div" style={{textAlign:"center"}}>You have already an account?
    <Link to={process.env.PUBLIC_URL + "/login"} className="link create-account">Login</Link>
     {/* <a href="/login" class="link create-account">Login</a> */}
     </div>
